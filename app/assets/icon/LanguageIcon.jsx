const LanguageIcon = ({size = 30, ...rest}) => {
    return <svg
        style={{
            transform: "translateY(6px)"
        }}
        width={size + "px"} height={size + "px"} {...rest}
        fill="var(--icon-color)" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet"
        xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier"><title>language-solid</title>
