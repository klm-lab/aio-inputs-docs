const CopyIcon = ({size = 25, ...rest}) => {
    return <svg stroke="var(--icon-color)" width={size + "px"} height={size + "px"} {...rest} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
