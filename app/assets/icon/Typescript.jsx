const Typescript = ({size = 25, ...rest}) => {
    return <svg width={size + "px"} height={size + "px"} {...rest} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="#000000">
        <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
        <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <rect x="2" y="2" width="28" height="28" rx="1.312" style={
                {fill: "#3178c6"}
            }></rect>
            <path
                ...
                style={{fill: "#ffffff", fillRule: "evenodd"}}></path>
        </g>
    </svg>
}
