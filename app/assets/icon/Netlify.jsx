const Netlify = ({size = 120, ...rest}) => {
    return <svg width={size + "px"} height={size + "px"} {...rest} version="1.1" id="layer" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px"
                viewBox="0 0 652 652" style={{enableBackground:"new 0 0 652 652"}} xmlSpace="preserve">
        <path fill="#1CB2AF" className="st0" d="M155.6,437.7v-61.4l1.3-1.3h12.8l1.3,1.3v61.4l-1.3,1.3h-12.8L155.6,437.7z M155.6,257.8v-61.4l1.3-1.3h12.8
	...
	l-9,9.1v1.8l21.1,21.1l9.6,0l1.3-1.3v-9.6L100,240.7z M19.3,309.4h87l1.3,1.3v12.8l-1.3,1.3h-87l-1.3-1.3v-12.8L19.3,309.4z
	 M534.8,309.4h81.9l1.3,1.3v12.8l-1.3,1.3h-87l-1.3-1.3l5.1-12.8L534.8,309.4z"/>
        <path fill="var(--netlify-color)" className="st1" d="M266.5,322.5l-1.3,1.3h-39.7l-1.3,1.3c0,2.6,2.6,10.2,12.8,10.2c3.8,0,7.7-1.3,9-3.8l1.3-1.3h15.4l1.3,1.3
